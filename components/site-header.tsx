    ...
    <>
      ...
      {content?.announcement?.enabled !== false && (
        <aside
          ...
          className="relative bg-[#1e1b4b] px-4 py-2 text-center text-xs font-medium text-white transition-colors select-none"
        >
          <div className="mx-auto flex max-w-7xl items-center justify-between gap-2 sm:px-6">
            <button
              type="button"
              ...
              {announcementIndex === 0 ? (
                ...
                >
                  ...
                  <button
                    ...
                    className="font-medium text-white underline underline-offset-2 hover:text-emerald-300 transition cursor-pointer truncate"
                  >
                    Create a free account for 15% off your next purchase
                  </button>
                </div>
              )}
            </div>
        ...
        <div className="mx-auto flex h-16 max-w-7xl items-center gap-4 px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="flex flex-col">
              <span className="font-heading text-lg font-bold tracking-tight text-primary leading-tight">
                SkillScale
              </span>
            ...
            {user ? (
              <div className="relative">
                <button
                  ...
                  aria-haspopup="menu"
                  className="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-2.5 py-1 text-xs font-semibold text-slate-800 shadow-2xs transition hover:bg-slate-50 active:scale-95 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#312E81]"
                >
                  <span className="flex size-6 items-center justify-center rounded-lg bg-[#312E81] text-[11px] font-bold text-white uppercase">
                    {user.name ? user.name.charAt(0) : 'U'}
                  </span>
                  <span className="font-semibold text-slate-800 max-w-[95px] truncate">
                ...
                {/* Dropdown Menu: My Account · My Purchases & Downloads · Order History · Wishlist · Log Out */}
                {accountDropdownOpen && (
                  <div
                    id="user-account-dropdown"
                    role="menu"
                    aria-orientation="vertical"
                    className="absolute right-0 mt-1.5 w-56 rounded-xl border border-slate-200 bg-white p-1.5 shadow-xl animate-in fade-in zoom-in-95 duration-100 z-50 text-xs"
                  >
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-xl border border-slate-200 bg-white px-3 py-1.5 text-xs font-semibold text-[#312E81] shadow-2xs transition hover:bg-slate-50 hover:border-slate-300 active:scale-95 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#312E81]"
              >
                <User className="size-3.5 text-[#312E81] shrink-0" />
                <span className="font-semibold">Account</span>
                <span className="hidden md:inline-flex rounded-md bg-emerald-500/10 px-1.5 py-0.5 text-[10px] font-bold text-[#10B981]">
                  15% Off
                </span>
              </button>
            )}
          ...
          <Button
            type="button"
            variant="ghost"
            className="relative size-10 p-0 ml-auto md:ml-0"
            onClick={openCart}
            aria-label={`Open shopping cart with ${cartCount} items`}
          >
            <ShoppingBag className="size-5" />
            {cartCount > 0 && (
              <span className="absolute -right-0.5 -top-0.5 flex size-5 items-center justify-center rounded-full bg-success text-[10px] font-bold text-success-foreground shadow">
                {cartCount}
              </span>
            )}
          </Button>
          ...
          <button
            ...
            className="flex size-10 items-center justify-center rounded-xl border border-border bg-card text-foreground transition hover:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary lg:hidden cursor-pointer"
          >
              ...
              <div className="border-t border-border mt-2 pt-2 space-y-1">
                {user ? (
                  <>
                    ...
                    >
                      <span className="inline-flex items-center gap-2">
                        <User className="size-4 text-[#312E81]" />
                  ...
                  <>
                    <button
                      ...
                      className="flex w-full items-center justify-between rounded-lg px-3.5 py-2.5 text-sm font-medium text-[#312E81] hover:bg-indigo-50/50 text-left cursor-pointer"
                    >
                      <span className="inline-flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="flex w-full items-center justify-between rounded-lg px-3.5 py-2.5 text-sm font-medium text-[#10B981] hover:bg-emerald-50 text-left cursor-pointer"
                    >
                      <span className="inline-flex items-center gap-2">
